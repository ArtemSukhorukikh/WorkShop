          ...
          <div class="col-md-6" data-aos="fade-up">
            <form action="contact_form_handler.php" method="post">
              ...
              <?php if(isset($_SESSION['success'])){
                ...
                }elseif(isset($_SESSION['errorEmptyData'])||isset($_SESSION['errorWrongEmail'])){
                  echo "<div class='alert alert-danger'>";
                  if ($_SESSION['errorEmptyData']){
                    echo "Error!Not all fields are filled in! Please check the entered data.";
                  }
                  if ($_SESSION['errorWrongEmail']){
